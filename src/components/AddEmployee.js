    ...
    <div className='flex max-w-2xl mx-auto shadow border-b'>
      <div className='px-8 py-8'>
         ...
         <div className='item-center justify-center h-14 w-full my-4 space-x-4 pt-4'>
            <button onClick={saveEmployee} className='rounded text-white font-semibold bg-green-400 hover:bg-green-700 py-2 px-2'>Save</button>
            <button 
            onClick={reset}
            className='rounded text-white font-semibold bg-red-400 hover:bg-red-700 py-2 px-2'>Clear</button>
         </div>
      </div>
    </div>
  );
